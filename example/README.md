...
## example/assets/lang/ar-EG.json
...
## example/assets/lang/en-US.json
...
### [example/lib/main.dart](https://github.com/aissat/localize_and_translate/blob/master/example/lib/main.dart)
...
void main() async{
  ...
  runApp(LocalizeAndTranslate(
    ...
    // install localize_and_translate_loader for enable custom loaders
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    log( LocalizeAndTranslate.of(context).locale.toString(), name: this.toString()+"# locale" );
    ...
    return MaterialApp(
      ...
      localizationsDelegates: [
        ...
        LocalizeAndTranslate.of(context).delegate,
      ],
      supportedLocales: LocalizeAndTranslate.of(context).supportedLocales,
      locale: LocalizeAndTranslate.of(context).locale,
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      home: MyHomePage(title: 'Localize And Translate'),
    );
  }
}
...
### [example/lib/lang_view.dart](https://github.com/aissat/localize_and_translate/blob/master/example/lib/lang_view.dart)
    ...
    return Container(
      ...
      child: ListTile(
          ...
          onTap: () {
            ...
            LocalizeAndTranslate.of(context).locale = locale;
          }),
    );
  }
}
